...
function renderForm($distributor, $error)
...
if ($distributor == '')
	...
	// if either field is blank, display the form again
		...
		mysql_query("INSERT distributor SET distributor='$distributor'")
		...
		header("Location: distributor_form.php");
